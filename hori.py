...
def show_analytics():
    ...
    with open("coin.txt", "a") as f: f.write(f"{avg_pts_per_orb}\n")
    with open("hit.txt", "a") as f: f.write(f"{hit_pc}\n")
    ...
    coin_history = load_data("coin.txt")
    hit_history = load_data("hit.txt")
